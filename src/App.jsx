...
/>}
        ...
        {page === "member-profile" && viewingMember && <ProfileHighlights member={viewingMember}/>}        {page === "member-profile" && viewingMember && <ProfileSocialTabs member={viewingMember} viewerProfile={profile} friendships={friendships} onOpenMember={openMember} onOpenGroup={(group) => { setSelectedGroup(group); setPage("groups"); }}/>}
