  ...
  useEffect(() => {
    const handleNavigation = (event) => {
      ...
      const pageMap = {
        ...
        events: "community", news: "news", ads: "community", profile: "profile",
...
function PasswordReset({ finishPasswordReset, notice }) { return <div className="auth-page"><div className="auth-welcome ec-auth-welcome"><section className="auth-intro ec-auth-intro"><img className="ec-auth-logo" src="/ennstal-connect-brand-2026.svg" alt="Ennstal Connect"/><span className="eyebrow">KONTO-SICHERHEIT</span><h1>Neues Passwort festlegen.</h1><p>Wähle ein sicheres neues Passwort für dein Ennstal-Connect-Konto.</p></section><div className="auth-box ec-auth-box"><form className="panel" onSubmit={finishPasswordReset}><h2>Passwort zurücksetzen</h2><input name="password" type="password" minLength={6} placeholder="Neues Passwort (mindestens 6 Zeichen)" required/><input name="confirm_password" type="password" minLength={6} placeholder="Passwort wiederholen" required/><button className="primary-button">Passwort speichern</button></form></div></div>{notice && <div className="toast">{notice}</div>}</div>; }
function NewAuth({ login, register }) {
  ...
  return <div className="auth-welcome ec-auth-welcome">
    <section className="auth-intro ec-auth-intro">
      <img className="ec-auth-logo" src="/ennstal-connect-brand-2026.svg" alt="Ennstal Connect"/>
