...
/>}
        ...
        {page === "municipality" && <section className="municipality-loading-host" aria-live="polite"><span className="eyebrow">GEMEINDE & SERVICE</span><h1>Gemeindebereich wird geladen …</h1><p>Offizielle Informationen, Bürgeranliegen und Services für {activeRegion?.name || "deine Region"}.</p></section>}
