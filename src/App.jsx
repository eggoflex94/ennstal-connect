...
export default function App() {
  ...
  const visibleMembers = useMemo(() => members.filter((m) => isAdmin(profile?.role) || (m.account_status !== "SUSPENDED" && !m.is_test_account)), [members, profile?.role]);
