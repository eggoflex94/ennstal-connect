...
function CommunityHub({ members, events, ads, photos }) {
  ...
  const admins = members.filter((member) => isAdmin(member.role) || (member.role === "SUPPORTER" && (member.forum_moderator || (member.admin_responsibilities || []).length > 0))).sort((a, b) => (a.role === "HEAD_ADMIN" ? -1 : b.role === "HEAD_ADMIN" ? 1 : a.role === "ADMIN" ? -1 : b.role === "ADMIN" ? 1 : getName(a).localeCompare(getName(b), "de")));
