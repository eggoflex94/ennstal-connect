...
export default function App() {
  ...
  async function saveProfile(e) {
    ...
    const layoutHours = { standard: 0, alpine: 5, aurora: 20, ocean: 35, slate: 50, ember: 70, redwood: 90, lavender: 110, midnight: 130, sunrise: 150 };
