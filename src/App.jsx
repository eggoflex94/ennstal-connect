...
function LegalPage({ type }) {
  ...
  return <section className="legal-page panel">
    ...
    {privacy ? <>
      ...
      <h2>Zweck</h2>
      <p>Regionale Community für Vernetzung, Kommunikation und Austausch im Ennstal und Umgebung.</p>
      <h2>Haftung für Mitgliederinhalte</h2>
      <p>Für selbst hochgeladene oder veröffentlichte Bilder, Texte, Nachrichten, Kommentare, Links und sonstige Inhalte sind die jeweiligen Mitglieder verantwortlich. Mitglieder müssen über die erforderlichen Rechte und Zustimmungen verfügen und dürfen insbesondere keine Urheber-, Persönlichkeits- oder Datenschutzrechte Dritter verletzen. Rechtswidrige Inhalte können an die Moderation gemeldet und entfernt werden. Gesetzlich zwingende Pflichten und Verantwortlichkeiten des Betreibers bleiben unberührt.</p>
    </>}
  </section>;
}
