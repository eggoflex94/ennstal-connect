...
function roleStar(person){const theme=themeFor(person||{});return theme==='admin'?'/role-star-red.svg':theme==='municipality'?(person?.role_star_url||'/role-star-green.svg'):theme==='supporter'?'/supporter-star.svg':theme==='business'?'/role-star-blue.svg':'/role-star-member.svg'}
