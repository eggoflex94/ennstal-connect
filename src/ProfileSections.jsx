  ...
  async function save(event) {
    ...
    try {
      ...
      const payload = {
        ...
        title: String(draft.title || '').trim(), body: String(draft.body || '').trim(),
