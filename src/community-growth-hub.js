...
async function renderOwnBusinessTools(){
  ...
  shell.querySelectorAll('[data-feature-business-event]').forEach((button)=>button.onclick=async()=>{
    ...
    const {error}=await supabase.rpc('set_community_event_featured',{p_event_id:button.dataset.featureBusinessEvent,p_featured:!featured});
