...
function showLegal(type){
  ...
  box.innerHTML = `<article class="ec-legal-box" role="dialog" aria-modal="true"><button class="ec-legal-close" aria-label="Schließen">×</button>
    ...
    ${privacy ? `
      <p>Diese Datenschutzhinweise beschreiben die grundlegende Verarbeitung personenbezogener Daten bei Ennstal Connect. Sie sind vor dem öffentlichen Betrieb mit den tatsächlichen Betreiber-, Hosting- und Kontaktangaben abzugleichen.</p>
      <h2>1. Verantwortlicher</h2><p><strong>Ennstal Connect</strong><br>E-Mail: ennsstal.connect@gmx.at<br>Die vollständige ladungsfähige Anschrift und der vollständige Name bzw. die Firma des Verantwortlichen sind vom Betreiber einzutragen.</p>
      ...
      <p class="notice"><strong>Hinweis:</strong> Vor dem Livegang müssen Betreibername und ladungsfähige Anschrift, konkrete Löschfristen, eingesetzte Dienste und die tatsächlichen Datenflüsse geprüft und vollständig dokumentiert werden.</p>` : `
      <p><strong>Ennstal Connect</strong></p>
      <h2>Betreiber / Medieninhaber</h2><p><strong>Ennstal Connect</strong><br>E-Mail: ennsstal.connect@gmx.at<br>Vollständiger Name bzw. Firmenname und ladungsfähige Anschrift des Betreibers/Medieninhabers sind hier einzutragen.</p>
      <h2>Verantwortlich für die Community</h2><p>Der eingetragene Global Admin ist für die Community-Organisation und Moderation verantwortlich. Die gesetzlich erforderlichen Betreiberangaben müssen mit den tatsächlichen Verhältnissen übereinstimmen.</p>
      ...
      <p class="notice"><strong>Wichtig:</strong> Für einen rechtssicheren öffentlichen Auftritt müssen insbesondere der vollständige Betreibername bzw. die Firma und die ladungsfähige Anschrift ergänzt werden. Je nach Rechtsform und konkreter Tätigkeit können zusätzliche Angaben erforderlich sein.</p>`}
  </article>`;
