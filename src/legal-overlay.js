...
function showLegal(type){
  ...
  box.innerHTML = `<article class="ec-legal-box" role="dialog" aria-modal="true"><button class="ec-legal-close" aria-label="Schließen">×</button>
    ...
    ${privacy ? `
      <p>Diese Datenschutzhinweise beschreiben die grundlegende Verarbeitung personenbezogener Daten bei Ennstal Connect. Sie sind vor dem öffentlichen Start mit den tatsächlichen Betreiber-, Hosting- und Kontaktangaben zu vervollständigen.</p>
      <h2>1. Verantwortlicher</h2><p><strong>[Name/Firma des Betreibers]</strong><br>[Anschrift]<br>[E-Mail-Adresse]</p>
      <h2>2. Welche Daten verarbeitet werden</h2><p>Je nach Nutzung können insbesondere E-Mail-Adresse, Nickname, Vor- und Nachname, Geburtsdatum, Geschlecht, Profilbild, Profilbeschreibung, Freundschaften, Nachrichten, Meldungen, technische Sitzungsdaten und Angaben zur Nutzung der Community verarbeitet werden.</p>
      ...
      <h2>4. Hosting und Dienstleister</h2><p>Für Authentifizierung und Datenbankfunktionen wird Supabase eingesetzt. Personenbezogene Daten dürfen nur im erforderlichen Umfang an eingesetzte Dienstleister übermittelt werden. Die konkrete Konfiguration, Auftragsverarbeitung und allfällige Drittlandübermittlungen sind vor Veröffentlichung zu prüfen.</p>
      <h2>5. Speicherdauer</h2><p>Daten werden nur so lange gespeichert, wie sie für den jeweiligen Zweck erforderlich sind oder gesetzliche Aufbewahrungspflichten bestehen. Konkrete Löschfristen sind vom Betreiber festzulegen.</p>
      ...
      <p class="notice"><strong>Wichtig:</strong> Vor dem Livegang müssen Betreibername, Anschrift, Kontakt, konkrete Löschfristen, eingesetzte Dienste und die tatsächlichen Datenflüsse ergänzt und rechtlich geprüft werden.</p>` : `
      <p><strong>Ennstal Connect</strong></p>
      <h2>Betreiber / Medieninhaber</h2><p>[Name/Firma des Betreibers]<br>[Anschrift]<br>[E-Mail-Adresse]</p>
      <h2>Verantwortlich für die Community</h2><p>Der eingetragene Global Admin ist für die Community-Organisation und Moderation verantwortlich. Die gesetzlich erforderlichen Betreiberangaben müssen hier vollständig und korrekt eingetragen werden.</p>
      ...
      <h2>Haftung für Inhalte</h2><p>Für von Mitgliedern erstellte Inhalte ist jeweils der veröffentlichende Nutzer verantwortlich. Rechtswidrige Inhalte können über die Meldefunktion an die Moderation gemeldet werden.</p>
      <h2>Kontakt</h2><p>[E-Mail-Adresse für rechtliche Anliegen]</p>
      <p class="notice"><strong>Wichtig:</strong> Das Impressum ist vor dem öffentlichen Start mit den echten Betreiberangaben zu vervollständigen. Je nach Rechtsform und konkreter Tätigkeit können zusätzliche Angaben erforderlich sein.</p>`}
  </article>`;
